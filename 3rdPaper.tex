...
\abstract{
We evaluated the performance of a Ce-doped fused-silica fiber as wavelength shifter coupled to a CeF$_3$ crystal using electron beams at CERN.   The pulse shape and collection efficiency were measured using irradiated (10 MRad) and un-irradiated fibers.  In addition, we evaluated the light yield of various Ce-doped fibers and explored the possibility of using these types of ``hybrid'' fibers in the future, including precision timing applications in high-luminosity collider environment.
}
