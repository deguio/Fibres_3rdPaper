...
We also measured the timing characteristics of the scintillation component of the signals for Phase-IV fiber. We found that the single exponential function describes the tails better (Fig.~\ref{fig:phase4scintTime}). The decay constants are $119.3 \pm 20.7$ ns and $102.3 \pm 10.3$ ns for un-irradiated and irradiated fibers, respectively. Sum of two exponential functions is used to model the tail of the signal from Phase-II fibers. The decay constants are $101.4 \pm 16.4$ ns and $31.1  \pm 7.8$ ns with relative contributions of $66 \pm 16 \%$ and $34 \pm 16 \%$ to the signal. We tested the double-exponent model on the signal from un-irradiated and irradiated Phase-IV with constrained decay constant at $31$ ns for the short component. We found that the fit favours relative contribution of $10 \pm 20\%$ and $6 \pm 11\%$, respectively.
...
\begin{center}
      ...
      \includegraphics[width=4.8cm]{Figures/B1_R11862_fit_zoom_singleLog.pdf}
       %%\vspace{-1pc}
\caption{\small The average signal from Phase-IV un-irradiated (left), irradiated (middle) and Phase-II (right) fibers. The tail of the scintillation signal is well described by a single exponential (red line) with a decay constant of $119.3 \pm 20.7$ ns and $102.3 \pm 10.3$ ns for Phase-IV un-irradiated and irradiated fibers respectively. The tail of the Phase-II scintillation signal is better described by sum of two exponents with decay constants of $101.4 \pm 16.4$ ns and $31.1  \pm 7.8$ ns and relative contributions of $66 \pm 16 \%$ and $34 \pm 16 \%$.}
    \label{fig:phase4scintTime}
\end{center}
\end{figure}

%R11864, phase4 un-irradiated in front
%SPE 525.213 +/- 10.6236
%Q [p.e] = 0.0924285
%S [p.e] = 0.14725
%S/Q = 1.59313
...
\item despite the large error bars, a visible degradation of the timing performance is visible for the irradiated fibres compared to the un-irradiated ones. This observation is interpreted as a worsening of the light transmission due to the formation of new color centers in the fibres lattice. Systematics associated to a not perfect coupling of the fibres with the PMT window can not be excluded;
